    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="/" class="logo d-flex align-items-center">
                <span class="d-none d-lg-block"><i class="bi bi-grid"></i> Dashboard</span>
            </a>
        </div><!-- End Logo -->
    </header><!-- End Header -->
                            ...
                            <div class="col-lg-12">
                                <div class="card-group">
                                    <div class="card text-bg-dark">
                                        <img src="https://images.unsplash.com/photo-1590231204765-12b10cedb4fa?q=80&w=1632&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" class="card-img" alt="University">
                                      </div>
                                  </div>
                            </div>
                        </div>
